document.addEventListener('keydown', (event) => {
    ...
    if (key == 65) {
    	...
    	document.getElementById('65').style.boxShadow = "0px 0px 1px 0px aqua";
        setTimeout(function() {
    ...
    if (key == 83) {
    	...
    	document.getElementById('83').style.boxShadow = "0px 0px 1px 0px aqua";
        setTimeout(function() {
    ...
    if (key == 68) {
    	...
    	document.getElementById('68').style.boxShadow = "0px 0px 1px 0px aqua";
        setTimeout(function() {
    ...
    if (key == 70) {
    	...
    	audio.currentTime = 0;
    	audio.play();
    	document.getElementById('70').style.backgroundColor = "aqua";
    	document.getElementById('70').style.boxShadow = "0px 0px 1px 0px purple";
        setTimeout(function() {
    ...
    if (key == 71) {
    	...
    	audio.currentTime = 0;
    	audio.play();
    	document.getElementById('71').style.backgroundColor = "aqua";
    	document.getElementById('71').style.boxShadow = "0px 0px 1px 0px purple";
        setTimeout(function() {
    ...
    if (key == 72) {
    	...
    	audio.currentTime = 0;
    	audio.play();
    	document.getElementById('72').style.backgroundColor = "aqua";
    	document.getElementById('72').style.boxShadow = "0px 0px 1px 0px purple";
        setTimeout(function() {
    ...
    if (key == 74) {
    	...
    	audio.currentTime = 0;
    	audio.play();
    	document.getElementById('74').style.backgroundColor = "aqua";
    	document.getElementById('74').style.boxShadow = "0px 0px 1px 0px purple";
        setTimeout(function() {
    ...
    if (key == 75) {
    	...
    	document.getElementById('75').style.boxShadow = "0px 0px 1px 0px white";
        setTimeout(function() {
    ...
    if (key == 76) {
    	...
    	audio.currentTime = 0;
    	audio.play();
    	document.getElementById('76').style.backgroundColor = "aqua";
    	document.getElementById('76').style.boxShadow = "0px 0px 1px 0px white";
        setTimeout(function() {
